...
def m2_conv ():
    print("m2_conv")
    array_input=np.load('m2_conv_imagenet_height.npy', allow_pickle=True)
    array_input=array_input.tolist()
    array_weight=np.load('m2_conv_imagenet_weight.npy', allow_pickle=True)
...
def m2_pool ():
    print("m2_pool")
    array_input=np.load('m2_pool_imagenet.npy', allow_pickle=True)
    array_input=array_input.tolist()
    batch_num = 128
    t1 = time.time()
    db = Client(host='localhost')
...
def m2_linear ():
    print("m2_linear")
    array_input=np.load('m2_linear_imagenet_height.npy', allow_pickle=True)
    array_input=array_input.tolist()
    array_weight=np.load('m2_linear_imagenet_weight.npy', allow_pickle=True)
    array_weight=array_weight.tolist()
    batch_num = 128
    t1 = time.time()
    db = Client(host='localhost')
...
def m4_conv ():
    print("m4_conv")
    array_input=np.load('m4_conv_imagenet_height.npy', allow_pickle=True)
    array_input=array_input.tolist()
    array_weight=np.load('m4_conv_imagenet_weight.npy', allow_pickle=True)
    array_weight=array_weight.tolist()
...
def m4_pool ():
    print("m4_pool")
    array_input=np.load('m4_pool_imagenet.npy', allow_pickle=True)
    array_input=array_input.tolist()
...
def m4_linear ():
    print("m4_linear")
    array_input=np.load('m4_linear_imagenet_height.npy', allow_pickle=True)
    array_input=array_input.tolist()
    array_weight=np.load('m4_linear_imagenet_weight.npy', allow_pickle=True)
    array_weight=array_weight.tolist()
