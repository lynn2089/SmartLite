...
#         x = self.features1(x)
#         e = time.time()
#         print("conv1 time:",e-s)

#         s = time.time()
#         x = self.features2(x)
#         e = time.time()
#         print("conv2 time:",e-s)

#         s = time.time()
#         x = self.features3(x)
#         e = time.time()
#         print("conv3 time:",e-s)

#         s = time.time()
#         x = self.features4(x)
#         e = time.time()
#         print("conv4 time:",e-s)

#         s = time.time()
#         x = self.features5(x)
#         e = time.time()
#         print("conv5 time:",e-s)

#         s = time.time()
#         x = x.view(-1, 256 * 6 * 6)
#         x = self.classifier(x)
#         e = time.time()
#         print("linear time:",e-s)
#         '''
#         x = self.features1(x)
#         x = self.features2(x)
#         x = self.features3(x)
...
#         self.ratioInfl=1
#         self.features1 = nn.Sequential(
#             BinarizeConv2d(3, int(96), kernel_size=11, stride=4, padding=2),
#             nn.MaxPool2d(kernel_size=3, stride=2),
...
class AlexNetOWT_BN(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        self.conv1 = BinarizeConv2d(int(256*self.ratioInfl), 256, kernel_size=3, padding=1)
