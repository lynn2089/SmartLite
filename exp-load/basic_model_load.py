...
q0_1= "select (((avg(val_pool))/stddevSamp(val_pool))+0.00005)>0?1:0 \
    from ( \
        ...
        from ( \
            select pool1, (lookup(cv1, k1))>181?1:0 as val, bn1 \
            from model0_conv1_2 \
        ) \
        group by pool1 \
    ) \
...
q0_5 = "select (((avg(val_pool))/stddevSamp(val_pool))+0.00005)>0?1:0 \
    from ( \
        ...
        group by cn_id2, pool2) \
    group by im_id22, kid22;"
q0_6 = "select (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
    +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
    +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
    +lookup(data2[9], kv2[9])+lookup(data2[10], kv2[10])+lookup(data2[11], kv2[11]) \
    +lookup(data2[12], kv2[12])+lookup(data2[13], kv2[13])+lookup(data2[14], kv2[14]) \
...
q0_7 = "select (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
    +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
    +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
    +lookup(data2[9], kv2[9])+lookup(data2[10], kv2[10])+lookup(data2[11], kv2[11]) \
    +lookup(data2[12], kv2[12])+lookup(data2[13], kv2[13])+lookup(data2[14], kv2[14]) \
...
q0_8 = "select (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
    +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
    +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
    +lookup(data2[9], kv2[9])+lookup(data2[10], kv2[10])+lookup(data2[11], kv2[11]) \
    +lookup(data2[12], kv2[12])+lookup(data2[13], kv2[13])+lookup(data2[14], kv2[14]) \
...
str_linear_vgg_db = "select ("
for i in range (1,129):
    str_linear_vgg_db = str_linear_vgg_db + "lookup(data2["+str(i)+"], kv2["+str(i)+"])"
    if i!=128:
...
q1_1 = "select (((avg(val))/stddevSamp(val))+0.00005)>0?1:0 \
    from ( \
        select (lookup(cv1, k1))>181?1:0 as val, bn1 \
        from model51_conv1_2 \
    ) \
    group by bn1;"
q1_2 = " select (((avg(val_cv2))/stddevSamp(val_cv2))+0.00005)>0?1:0 \
    from ( \
        select cn_id2, im_id2, kid2, (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
        )>288?1:0 as val_cv2 \
...
q1_15 = "select (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
    +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
    +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
    +lookup(data2[9], kv2[9])+lookup(data2[10], kv2[10])+lookup(data2[11], kv2[11]) \
    +lookup(data2[12], kv2[12])+lookup(data2[13], kv2[13])+lookup(data2[14], kv2[14]) \
...
q1_16 = "select (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
    +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
    +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
    +lookup(data2[9], kv2[9])+lookup(data2[10], kv2[10])+lookup(data2[11], kv2[11]) \
    +lookup(data2[12], kv2[12])+lookup(data2[13], kv2[13])+lookup(data2[14], kv2[14]) \
...
str_linear_resnet_db = "select ("
for i in range (1,20):
    str_linear_resnet_db = str_linear_resnet_db + "lookup(data2["+str(i)+"], kv2["+str(i)+"])"
    if i!=19:
...
str_linear_vgg_prune = "select ("
for i in range (1,99):
    str_linear_vgg_prune = str_linear_vgg_prune + "lookup(data2["+str(i)+"], kv2["+str(i)+"])"
    if i!=98:
...
q6_1 = "select (((avg(val))/stddevSamp(val))+0.00005)>0?1:0 \
    from ( \
        select (lookup(cv1, k1))>140?1:0 as val, bn1 \
        from modelvgg16_prune_conv1_2 \
    ) \
    group by bn1;"
q6_2 = " select (((avg(val_cv2))/stddevSamp(val_cv2))+0.00005)>0?1:0 \
    from ( \
        select cn_id2, im_id2, kid2, (lookup(data2[1], kv2[1]) \
        )>223?1:0 as val_cv2 \
        from (select cn_id2, im_id2, kid2, data2, kv2 \
        from (select cn_id2, any(im_id1) as im_id2, groupArray(data1) as data2 \
        from ( \
...
q6_5 = " select (((avg(val_cv2))/stddevSamp(val_cv2))+0.00005)>0?1:0 \
    from ( \
        select cn_id2, im_id2, kid2, (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
        +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
        +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7]) \
        )>893?1:0 as val_cv2 \
        from (select cn_id2, im_id2, kid2, data2, kv2 \
        from (select cn_id2, any(im_id1) as im_id2, groupArray(data1) as data2 \
        from ( \
...
q6_15 = "select (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
    +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
    +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
    +lookup(data2[9], kv2[9])+lookup(data2[10], kv2[10])+lookup(data2[11], kv2[11]) \
    +lookup(data2[12], kv2[12]))>1589?1:0 as val_cv2 \
    from (select data2, kv1 as kv2 \
    from (select groupArray(data1) as data2 \
    from ( \
...
q6_16 = "select (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
    +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
    +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
    +lookup(data2[9], kv2[9])+lookup(data2[10], kv2[10])+lookup(data2[11], kv2[11]) \
    +lookup(data2[12], kv2[12]))>1589?1:0 as val_cv2 \
...
q7_1= "select (((avg(val_pool))/stddevSamp(val_pool))+0.00005)>0?1:0 \
    from ( \
        select max(val)>0?1:0 as val_pool, any(bn1) as bn11 \
        from ( \
            select pool1, (lookup(cv1, k1))>129?1:0 as val, bn1 \
...
q7_2 = " select (((avg(val_pool))/stddevSamp(val_pool))+0.00005)>0?1:0 \
    from ( \
        ...
        from ( \
            ...
            +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
            +lookup(data2[9], kv2[9])+lookup(data2[10], kv2[10])+lookup(data2[11], kv2[11]) \
            +lookup(data2[12], kv2[12])+lookup(data2[13], kv2[13]))>1645?1:0 as val_cv2 \
            from (select cn_id2, pool2, im_id2, kid2, data2, kv2 \
            from (select cn_id2, any(im_id1) as im_id2, groupArray(data1) as data2 \
            from ( \
...
q7_3 = "select (((avg(val_cv2))/stddevSamp(val_cv2))+0.00005)>0?1:0 \
    from ( \
        select im_id2, kid2, (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
        +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
        +lookup(data2[6], kv2[6]))>822?1:0 as val_cv2 \
        from (select im_id2, kid2, data2, kv2 \
        from (select any(im_id1) as im_id2, groupArray(data1) as data2 \
        from ( \
...
q7_4 = "select (((avg(val_cv2))/stddevSamp(val_cv2))+0.00005)>0?1:0 \
    from ( \
        ...
        +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
        +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
        +lookup(data2[9], kv2[9]))>1233?1:0 as val_cv2 \
        from (select im_id2, kid2, data2, kv2 \
        from (select any(im_id1) as im_id2, groupArray(data1) as data2 \
        from ( \
...
q7_5 = "select (((avg(val_pool))/stddevSamp(val_pool))+0.00005)>0?1:0 \
    from ( \
        ...
        group by cn_id2, pool2) \
    group by im_id22, kid22;"
q7_6 = "select (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
    +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
    +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
    +lookup(data2[9], kv2[9])+lookup(data2[10], kv2[10])+lookup(data2[11], kv2[11]) \
    +lookup(data2[12], kv2[12])+lookup(data2[13], kv2[13])+lookup(data2[14], kv2[14]) \
    ...
    +lookup(data2[19], kv2[19])+lookup(data2[20], kv2[20])+lookup(data2[21], kv2[21]) \
    +lookup(data2[22], kv2[22])+lookup(data2[23], kv2[23])+lookup(data2[24], kv2[24]) \
    +lookup(data2[25], kv2[25]))>3290?1:0 as val_cv2 \
    from (select data2, kv1 as kv2 \
    from (select groupArray(data1) as data2 \
    from ( \
...
q7_7 = "select (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
    +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
    +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
    +lookup(data2[9], kv2[9])+lookup(data2[10], kv2[10])+lookup(data2[11], kv2[11]) \
    )>1462?1:0 as val_cv2 \
...
q7_8 = "select (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
    +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4])+lookup(data2[5], kv2[5]) \
    +lookup(data2[6], kv2[6])+lookup(data2[7], kv2[7])+lookup(data2[8], kv2[8]) \
    +lookup(data2[9], kv2[9])+lookup(data2[10], kv2[10])+lookup(data2[11], kv2[11]) \
    )>1462?1:0 as val_cv2 \
...
str_linear_resnet_prune = "select ("
for i in range (1,15):
    str_linear_resnet_prune = str_linear_resnet_prune + "lookup(data2["+str(i)+"], kv2["+str(i)+"])"
    if i!=14:
...
q8_5 = " select (((avg(val_cv2))/stddevSamp(val_cv2))+0.00005)>0?1:0 \
    from ( \
        select cn_id2, im_id2, kid2, (lookup(data2[1], kv2[1])+lookup(data2[2], kv2[2]) \
        +lookup(data2[3], kv2[3])+lookup(data2[4], kv2[4]) \
        )>440?1:0 as val_cv2 \
        from (select cn_id2, im_id2, kid2, data2, kv2 \
        from (select cn_id2, any(im_id1) as im_id2, groupArray(data1) as data2 \
        from ( \
