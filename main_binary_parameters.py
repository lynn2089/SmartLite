...
#                     help='type of tensor - e.g torch.cuda.HalfTensor')   #gpu
parser.add_argument('--type', default='torch.FloatTensor',
                    help='type of tensor - e.g torch.HalfTensor')
...
def main():
    ...
    if args.evaluate:
        ...
        # checkpoint = torch.load(args.evaluate) #original code
...
def forward(data_loader, model, criterion, epoch=0, training=True, optimizer=None):
    ...
    output_conv1=model.conv1(input_var)
    # print("conv1: ")
