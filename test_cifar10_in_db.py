...
def m2_conv ():
    print("m2_conv")
    array_input = torch.rand(262144, 27)-0.5 #db
    array_weight = torch.rand(27, 80)-0.5 #db
    batch_num = 128
    t1 = time.time()
    db = Client(host='localhost')
...
def m2_pool ():
    print("m2_pool")
    array_input = torch.rand(128000*3*8*8, 16)-0.5 #db
    batch_num = 128
    t1 = time.time()
    db = Client(host='localhost')
...
def m2_linear ():
    print("m2_linear")
    array_input = torch.rand(128000, 320)-0.5 #db
    array_weight = torch.rand(10, 320)-0.5 #db
    batch_num = 128
    t1 = time.time()
    db = Client(host='localhost')
...
def m4_conv ():
    print("m4_conv")
    array_input = torch.sign(torch.rand(262144, 27)-0.5) #db
    array_weight = torch.sign(torch.rand(27, 80)-0.5) #db
...
def m4_pool ():
    print("m4_pool")
    array_input = torch.sign(torch.rand(128000*3*8*8, 16)-0.5) #db
...
def m4_linear ():
    print("m4_linear")
    array_input = torch.sign(torch.rand(128000, 320)-0.5) #db
    array_weight = torch.sign(torch.rand(10, 320)-0.5) #db
