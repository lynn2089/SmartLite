...
# Store the quantized binarized neural network parameters into the database.
...
class BinarizeConv2dinDB(nn.Conv2d):
    ...
    def forward(self, input):
        ...
        # The storage of NNs in DBMS need to be updated according to the strategy.
        # The storage kernel will be uploaded later.
